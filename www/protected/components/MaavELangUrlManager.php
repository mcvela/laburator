 ...
 * @version 1.0
 */
class MaavELangUrlManager extends CUrlManager
{
    /**
    ...
    public function init()
    {
		...
		//// Cargar el usuario
		if (Yii::app()->session['photourl']!=null || Yii::app()->session['photourl']!=""){
		  /*  
			...
			if ($profileFields) {
				foreach($profileFields as $field) {
				   if ($field->varname=="photourl"){
					  Yii::app()->session['photourl']=$profile->getAttribute($field->varname);
				   }
				}
			}
			*/
	    ...
	    // Yii::app()->session['photourl']="/images/maav.jpg";
