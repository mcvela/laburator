<?php
$main = require(dirname(__FILE__).'/main.php');	//reading base front-end config in order to not keep common sections independently.
...
$main['components'] = array(
	 ...
	 */
		'class'=>'CDbConnection',
		'connectionString' => 'mysql:host=localhost;dbname=autoadmin_test',
		'emulatePrepare' => true,
		'username' => 'root',
		'password' => '',
		'charset' => 'utf8',
