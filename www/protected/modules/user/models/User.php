...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return ((Yii::app()->getModule('user')->isAdmin())?array(
			#array(password, email', 'required'),//'username, 
	...
	public function scopes()
    {
        return array(
            ...
            'notsafe'=>array(
            	'select' => 'id, password, email, activkey, createtime, lastvisit, superuser, status', //username,
            ),
        );
    }
    ...
    {
        return array(
            'select' => 'id,  email, createtime, lastvisit, superuser, status', //username,
        );
    }
