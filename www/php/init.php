...
$mysql = new mysqli($conf['db_hostname'], $conf['db_username'], $conf['db_password'], $conf['db_name'],$conf['db_port']);
if ($mysql->connect_errno) {
	die("1.Error during MySQL database connection : (" . $mysql->connect_errno . ") " . $mysql->connect_error."--->".$conf['db_hostname']."-". $conf['db_username']."-".$conf['db_name']);
