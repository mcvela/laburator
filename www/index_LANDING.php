...
<html lang="en">
    ...
    <head>
        ...
        <title>Laburator. Encuentra trabajo, sin tener que buscarlo</title>
        ...
        <link rel="stylesheet" href="assets_design/font-awesome/css/font-awesome.min.css">
        <link rel="stylesheet" href="assets_design/css/animate.css">
        <link rel="stylesheet" href="assets_design/ultimate-flat-social-icons/ultm-css/ultm.css">
		<link rel="stylesheet" href="assets_design/css/form-elements.css">
        <link rel="stylesheet" href="assets_design/css/style.css">
        <link rel="stylesheet" href="assets_design/css/media-queries.css">
		*/?>
		 <link rel="stylesheet" href="assets_design/css/all.min.css">
...
.rel {
    ...
    <body>
		...
		<nav>
			...
			<a class="scroll-link" href="#top-content">Suscr&iacute;bete</a>
			<a class="scroll-link" href="#features">¿C&oacutemo puedo ayudarte?</a>
			<?php /* <a class="scroll-link" href="#testimonials">Citas</a> */?>
			<a class="scroll-link" href="#contact">¿Alguna duda?</a>
			<div class="hide-menu">
                    ...
                    <div class="row">
                        <div class="col-sm-12 subscribe section-description wow fadeIn">
                        	<div class="logo wow fadeInDown">
						 	...
						 	<h1 class="wow fadeInLeftBig">&iexcl;Encuentra trabajo sin tener que buscarlo&#33;</h1>
							 
                            <div class="description wow fadeInLeftBig">
                            	Te ayudamos a salir de los:  
                            </div>
							<div id="slideshow" class="carousel slide vertical scrollpoint sp-effect3 active animated fadeInDown" data-ride="carousel">
							<div class="carousel-inner">
								
								<div id="title" class="item font-effect-emboss wobble-top"><h3>4.526.804 desempleados <small>(España <img src="./images/languages/es.png">)</small></h3></div>
							    <div id="title" class="item  font-effect-emboss wobble-top"><h3>2.062.000 desempleados <small>(Alemania <img src="./images/languages/de.png">)</small></h3></div>
							   <div id="title" class="item font-effect-emboss wobble-top active"><h3>3.093.000 desempleados <small>(Francia <img src="./images/languages/fr.png">)</small></h3></div>
                               <div id="title" class="item font-effect-emboss wobble-top"><h3>1.909.000 desempleados <small>(Inglaterra <img src="./images/languages/en.png">)</small></h3></div>
							   <div id="title" class="item font-effect-emboss wobble-top"><h3>3.410.000 desempleados <small>(Italia <img src="./images/languages/it.png">)</small></h3></div>
							   <div id="title" class="item font-effect-emboss wobble-top"><h3>1.263.000 desempleados <small>(Grecia <img src="./images/languages/gr.png">)</small></h3></div>
                       ...
                       <?php   
						...
						<?php /* if ($conf['newsletter_activated']) {	?>
							  <div class="subscribe">
	        ...
	        <div class="container">
	            <div class="row">
	                <div class="col-sm-12 features section-description wow fadeIn">
	                    ...
	                    <p>
	                    	Laburator trabaja incansablemente para conseguirte ofertas de trabajo, <br>solo v&aacute;lidas para ti
	                    </p>
	                </div>
	            </div>
	            <div class="row">
                	<div class="col-sm-4 features-box wow fadeInUp">
	                    ...
	                    <h3>B&uacute;squeda autom&aacute;tica</h3>
	                    <p>Obt&eacute;n ofertas compatibles con tus preferencias, en m&uacute;ltiples fuentes de trabajo.</p>
                    </div>
                    <div class="col-sm-4 features-box wow fadeInDown">
	                	<div class="features-box-icon">
	                		<i class="fa fa-hand-o-up"></i>
	                	</div>
	                    <h3>Inscripción autom&aacute;tica</h3>
	                    <p>Laburator te colocar&aacute; el primero de las largas listas de candidatos.</p>
                    </div>
                    <div class="col-sm-4 features-box wow fadeInUp">
	                	<div class="features-box-icon">
	                		<i class="fa fa-file-text-o"></i>
	                	</div>
	                    <h3>1 Curriculum por oferta</h3>
	                    <p>Personaliza la presentación de tu perfil y curriculum para maximizar tus opciones en cada oferta</p>
                    </div>
	            </div>
	            <div class="row">
	            	<div class="col-sm-12">
...
<?php /*
	                ...
	                <div class="col-sm-12 contact-form wow fadeInLeft ">
	                    ...
	                    <form role="form" action="assets_design/contact.php" method="post">
	                        ...
	                        <div class="form-group">
	                        	...
	                        	<textarea name="message" placeholder="Mensaje..." class="contact-message" id="contact-message"></textarea>
	                        </div>
	                        <div style="text-align:center;">
								<button type="submit" class="btn pull-center">Enviar</button>
							</div>
	                    </form>
	                </div>
  ...
  <?php 
     /*  <script src="assets_design/js/jquery-1.10.2.min.js"></script> 
		...
		*/?>
		<script src="assets_design/js/all.min.js"></script>
