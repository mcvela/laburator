...
jQuery(document).ready(function() {
    ...
    */
    if (imagenesFondo.length>0) $.backstretch(imagenesFondo, {duration: 3000, fade: 750});
	...
	*/
	...
	$('.subscribe form').submit(function(e) {
	    ...
	    $.ajax({
	        type: 'POST',
	        url: 'assets_design/subscribe.php',
	        data: postdata,
	        dataType: 'json',
	        ...
	        success: function(json) {
	            ...
	            if(json.emailMessage == '' && json.subjectMessage == '' && json.messageMessage == '') {
	                $('.contact-form form').fadeOut('fast', function() {
						...
						$('#respuestaContact').append('<p>'+respuestaContact+'</p>');
	                });
	            }
	        }
	    });
